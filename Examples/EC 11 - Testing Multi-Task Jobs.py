...
# MAGIC 
# MAGIC The definition for each of these can be found in [Classroom-Setup-11]($../Includes/_multi-task-jobs-config) and [_multi-task-jobs-config]($../Includes/Classroom-Setup-11)
